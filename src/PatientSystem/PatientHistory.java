...
public class PatientHistory extends javax.swing.JFrame {
    ...
    public PatientHistory(PersonDirectory person,HospitalDirectory hospital,PatientDirectory patient,CityDirectory city,CommunityDirectory community, DoctorDirectory doctor) {
        this.person = person;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Patient history portal");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(patientName, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(91, 91, 91)))
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        name.setText(patientName.getSelectedItem().toString());
        int i=0;
        for(Patient e: patient.getPatient()){
            System.out.println(e.getPerson().getName());
                if(e.getPerson().getName().equals(patientName.getSelectedItem().toString())){
                    for(Encounter encounter : e.encounterHistory.getEncounter()){
                      Object[] row = {encounter.getVital().getBloodPressure(),encounter.getVital().getHeartRate(),encounter.getVital().getRespiratoryRate(), encounter.getDateOfAppointement()};
                    model.addRow(row);
